...
export default function CompactMeetingBar({
  ...
  return (
    <div className="w-full rounded-xl border border-white/30 dark:border-white/10 bg-gradient-to-r from-emerald-mist/10 via-white/70 dark:from-[#10B981]/10 dark:via-[#1A1A1A]/80 to-white/60 dark:to-[#121212]/80 backdrop-blur-md shadow-soft-card px-4 py-2 flex items-center justify-between">
