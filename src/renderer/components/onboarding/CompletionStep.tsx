  ...
  return (
    <div className="text-center space-y-6">
      <div className="flex justify-center mb-4">
        <div className="w-20 h-20 rounded-full bg-cream/10 flex items-center justify-center">
      ...
      <div className="pt-8">
        <button
          onClick={onFinish}
          className="w-full py-3 px-6 bg-accent hover:bg-accent-hover text-white rounded-lg font-medium transition-colors"
        >
          Go to Home
        </button>
      </div>
